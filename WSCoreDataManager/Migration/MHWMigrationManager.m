                          ...
                          error:(NSError **)error
{
    ...
    [manager addObserver:self
              forKeyPath:@"migrationProgress"
                 ...
                 context:nil];
    BOOL didMigrate = NO;
    for (NSMappingModel *nextMappingModel in mappingModels) {
        didMigrate = [manager migrateStoreFromURL:sourceStoreURL
                                             type:type
                                          options:nil
                                 withMappingModel:nextMappingModel
...
- (NSURL *)destinationStoreURLWithSourceStoreURL:(NSURL *)sourceStoreURL
    ...
    return [url URLByAppendingPathComponent:[NSString stringWithFormat:@"%@.%@", modelName, storeExtension]];
}
...
//        DDLogVerbose(@"progress: %f", [object migrationProgress]);
